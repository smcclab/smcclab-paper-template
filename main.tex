...
\begin{abstract}
  ...
  paper is complete.
  %% In SMCClab we follow this abstract formula with seven sentences, please align abstract to this form. (You may have two sentences for some points if necessary, but be prepared to argue with me about why necessary).
...
\begin{acks}
Some unsorted acknowledgments.

\begin{itemize}
  \item Jim Wallace's CHIZen checklist: \url{https://github.com/JimWallace/CHI-Zen}
  \item Lennart Nacke's work: \url{https://www.lennartnacke.com/}
\end{itemize}
\end{acks}
